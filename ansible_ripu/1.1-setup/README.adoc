...
* link:#workshop-exercise---your-lab-environment[Workshop Exercise -
Your Lab Environment]
** link:#table-of-contents[Table of Contents]
** link:#objectives[Objectives]
** link:#guide[Guide]
*** link:#your-lab-environment[Your Lab Environment]
*** link:#step-1---access-the-environment[Step 1 - Access the
Environment]
*** link:#step-2---open-a-terminal-session[Step 2 - Open a Terminal
Session]
*** link:#step-3---access-the-aap-web-ui[Step 3 - Access the AAP Web UI]
*** link:#step-4---access-the-rhel-web-console[Step 4 - Access the RHEL
Web Console]
*** link:#step-5---challenge-labs[Step 5 - Challenge Labs]
...
link:../1.2-preupg/README.md[Next Exercise]
