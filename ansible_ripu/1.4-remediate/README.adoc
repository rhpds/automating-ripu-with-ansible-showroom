...
* link:#workshop-exercise---perform-recommended-remediation[Workshop
Exercise - Perform Recommended Remediation]
** link:#table-of-contents[Table of Contents]
** link:#objectives[Objectives]
** link:#guide[Guide]
*** link:#step-1---explore-options-for-resolving-inhibitors[Step 1 -
Explore Options for Resolving Inhibitors]
*** link:#step-2---managing-the-leapp-answer-file[Step 2 - Managing the
Leapp Answer File]
*** link:#step-3---resolving-inhibitors-using-a-remediation-playbook[Step
3 - Resolving Inhibitors Using a Remediation Playbook]
...
image::images/ripu-workflow-hl-remediate.svg[Automation approach
workflow diagram with apply recommended remediations step highlighted]

* Let’s start by dissecting one of our inhibitor findings:
+
image::images/missing_answers_dissected.svg[Details view of missing
required answers in the answer file]
+
image:images/circle_1.svg[1.] Each finding has a unique title.
+
image:images/circle_2.svg[2.] A risk factor is assigned to each finding,
...
+
image:images/circle_3.svg[3.] The summary provides a detailed
explanation of the risk and solution recommendation.
+
image:images/circle_4.svg[4.] Under remediation, we are given a fairly
prescriptive recommendation.
+
image:images/circle_5.svg[5.] Sometimes, the remediation also includes
...
For example:
+
image::images/analysis_leapp_answerfile.svg[Setting the
`leapp_answerfile` input variable]
+
...
+
image::images/analysis_survey_rhel7_only.svg[Choose ``rhel7'' at the
survey prompt]
+
...
For example:
+
image::images/rhel7_answer_fixed.svg[Pre-upgrade report of RHEL7 host
without answer file inhibitor]
+
...
+
image::../1.3-report/images/root_account_inhibitor.svg[Details view of
...
+
image::images/rhel7_no_inhibitors.svg[Pre-upgrade report of RHEL7 host
with no more inhibitors]
+
...
link:../1.3-report/README.md[Previous Exercise] -
link:../1.5-custom-modules/README.md[Next Exercise]
