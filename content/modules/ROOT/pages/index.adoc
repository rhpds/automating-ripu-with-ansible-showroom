...
image::images/ripu_key_features.svg[Automate Everything,
Snapshot/rollback, Custom Modules, Reporting Dashboard]
...
image::images/ripu_lab_diagram.svg[RHEL In-place Upgrade Automation
Workshop lab diagram]
...
* link:1.1-setup/README.adoc[Exercise 1.1 - Workshop Lab Environment]
* link:1.2-preupg/README.adoc[Exercise 1.2 - Run Pre-upgrade Jobs]
* link:1.3-report/README.adoc[Exercise 1.3 - Review Pre-upgrade Reports]
* link:1.4-remediate/README.adoc[Exercise 1.4 - Perform Recommended Remediation]
* link:1.5-custom-modules/README.adoc[Exercise 1.5 - Custom Pre-upgrade Checks]
* link:1.6-my-pet-app/README.adoc[Exercise 1.6 - Deploy a Pet App]

==== Section 2 - RHEL OS Upgrade

* link:2.1-upgrade/README.adoc[Exercise 2.1 - Run OS Upgrade Jobs]
* link:2.2-snapshots/README.adoc[Exercise 2.2 - Let’s Talk About Snapshots]
* link:2.3-check-upg/README.adoc[Exercise 2.3 - Check if the Upgrade Worked]
* link:2.4-check-pet-app/README.adoc[Exercise 2.4 - (Optional) How is the Pet App Doing?]

==== Section 3 - Rolling Back

* link:3.1-rm-rf/README.adoc[Exercise 3.1 - (Optional) Trash the Instance]
* link:3.2-rollback/README.adoc[Exercise 3.2 - Run Rollback Job]
* link:3.3-check-undo/README.adoc[Exercise 3.3 - Check if Upgrade Undone]
* link:3.4-conclusion/README.adoc[Exercise 3.4 - Rinse and Repeat]
...
link:1.1-setup/README.adoc[Next Exercise]
