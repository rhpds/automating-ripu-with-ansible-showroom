...
image::ripu-workflow-hl-validate.svg[Automation approach workflow
...
+
image::upgrade_play_recap.svg[AAP Web UI showing successful
...
reporting RHEL9:
+
image::rhel9_upgraded.svg[fluent-bee running Red Hat Enterprise
Linux 9.2 (Plow)]
+
Here is an example one that was previously RHEL7 now running RHEL8:
+
image::rhel8_upgraded.svg[vocal-hyena running Red Hat Enterprise
...
+
image::rhel9_commands.svg[command output showing RHEL9 is
installed]
