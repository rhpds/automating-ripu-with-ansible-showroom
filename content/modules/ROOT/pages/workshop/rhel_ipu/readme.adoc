...
image::images/ripu_key_features.svg[Automate Everything, Snapshot/rollback, Custom Modules, Reporting Dashboard]

As you progress through this workshop, you will learn more about the importance of these features and the different options for how you might implement them in your enterprise. For this workshop, we assume you have at least some experience using Ansible Automation Platform and working with Ansible playbooks and roles. If you’re new to Ansible, consider first completing the workshop https://labs.demoredhat.com/exercises/ansible_rhel[Ansible for Red Hat Enterprise Linux].

=== Table of Contents

* link:#rhel-in-place-upgrade-automation-workshop[RHEL In-place Upgrade Automation Workshop]
...
image::images/ripu_lab_diagram.svg[RHEL In-place Upgrade Automation Workshop lab diagram]
...
* link:1.1-setup/README.md[Exercise 1.1 - Workshop Lab Environment]
* link:1.2-preupg/README.md[Exercise 1.2 - Run Pre-upgrade Jobs]
* link:1.3-report/README.md[Exercise 1.3 - Review Pre-upgrade Reports]
* link:1.4-remediate/README.md[Exercise 1.4 - Perform Recommended Remediation]
* link:1.5-custom-modules/README.md[Exercise 1.5 - (Optional) Custom Pre-upgrade Checks]
* link:1.6-my-pet-app/README.md[Exercise 1.6 - (Optional) Deploy a Pet App]

==== Section 2 - RHEL OS Upgrade

* link:2.1-upgrade/README.md[Exercise 2.1 - Run OS Upgrade Jobs]
* link:2.2-snapshots/README.md[Exercise 2.2 - Let’s Talk About Snapshots]
* link:2.3-check-upg/README.md[Exercise 2.3 - Check if the Upgrade Worked]
* link:2.4-check-pet-app/README.md[Exercise 2.4 - (Optional) How is the Pet App Doing?]
...
* link:3.3-check-undo/README.md[Exercise 3.3 - Check if Upgrade Undone]
* link:3.4-conclusion/README.md[Exercise 3.4 - Rinse and Repeat]
...
link:1.1-setup/README.md[Next Exercise]
