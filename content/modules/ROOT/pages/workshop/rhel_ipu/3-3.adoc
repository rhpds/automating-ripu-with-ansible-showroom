...
* link:#workshop-exercise---check-if-upgrade-undone[Workshop Exercise - Check if Upgrade Undone]
** link:#table-of-contents[Table of Contents]
** link:#objectives[Objectives]
** link:#guide[Guide]
*** link:#step-1---our-state-after-rolling-back[Step 1 - Our State After Rolling Back]
...
* If you inflicted some damage to the pet app server with the optional link:../3.1-rm-rf/README.md[Trash the Instance] exercise, you will now find no evidence of that.
+
...
* If you installed the Spring Pet Clinic Sample Application from the optional link:../1.6-my-pet-app/README.md[Deploy a Pet App] exercise, refresh the web user interface in your browser to verify it is running correctly after rolling back.
+
____
*Note*
...
link:../3.2-rollback/README.md[Previous Exercise] - link:../3.4-conclusion/README.md[Next Exercise]
