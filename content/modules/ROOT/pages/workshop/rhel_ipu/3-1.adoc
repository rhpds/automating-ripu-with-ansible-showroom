...
* link:#workshop-exercise---trash-the-instance[Workshop Exercise - Trash the Instance]
** link:#table-of-contents[Table of Contents]
** link:#optional-exercise[Optional Exercise]
** link:#objectives[Objectives]
** link:#guide[Guide]
*** link:#step-1---select-a-pet-app-server[Step 1 - Select a Pet App Server]
...
* Follow the steps you used with link:../1.1-setup/README.md#step-2---open-a-terminal-session[Exercise 1.1: Step 2] to open a terminal session on the app server you have chosen to roll back.
...
* In link:../1.6-my-pet-app/README.md#step-5---run-another-pre-upgrade-report[Exercise 1.6: Step 5], we observed a pre-upgrade finding warning of a potential risk that our `temurin-17-jdk` 3rd-party JDK runtime package might be removed during the upgrade in case it had unresolvable dependencies. Of course, we know this did not happen because our pet app is still working perfectly.
+
...
link:../2.4-check-pet-app/README.md[Previous Exercise] - link:../3.2-rollback/README.md[Next Exercise]
