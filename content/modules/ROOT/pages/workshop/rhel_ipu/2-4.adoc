...
* link:#workshop-exercise---how-is-the-pet-app-doing[Workshop Exercise - How is the Pet App Doing?]
** link:#table-of-contents[Table of Contents]
** link:#objectives[Objectives]
** link:#guide[Guide]
*** link:#step-1---retest-our-pet-application[Step 1 - Retest our Pet Application]
*** link:#step-2---add-more-records-to-the-database[Step 2 - Add More Records to the Database]
...
In link:../1.6-my-pet-app/README.md[Exercise 1.6] we installed a sample pet application and tested its functionality. Now that we have upgraded the RHEL version of our app server, let’s retest to see if there has been any impact.

==== Step 1 - Retest our Pet Application

It’s time to repeat the testing you did for link:../1.6-my-pet-app/README.md#step-3---test-the-pet-application[Step 3] in the previous exercise.
...
In link:../2.2-snapshots/README.md[Exercise 2.2], we considered the potential pitfalls of including app data in the scope of our snapshot. Imagine what would happen if your app at first appeared fine after the upgrade, but an issue was later discovered after the app had been returned to production use.
...
link:../2.3-check-upg/README.md[Previous Exercise] - link:../3.1-rm-rf/README.md[Next Exercise]
