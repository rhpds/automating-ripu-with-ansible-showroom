...
*** link:#section-1---pre-upgrade-analysis[Section 1 - Pre-upgrade
Analysis]
...
* link:1.4-remediate/README.md[Exercise 1.4 - Perform Recommended
Remediation]
* link:1.5-custom-modules/README.md[Exercise 1.5 - (Optional) Custom
Pre-upgrade Checks]
* link:1.6-my-pet-app/README.md[Exercise 1.6 - (Optional) Deploy a Pet
App]

==== Section 2 - RHEL OS Upgrade

* link:2.1-upgrade/README.md[Exercise 2.1 - Run OS Upgrade Jobs]
* link:2.2-snapshots/README.md[Exercise 2.2 - Let’s Talk About
Snapshots]
* link:2.3-check-upg/README.md[Exercise 2.3 - Check if the Upgrade
Worked]
* link:2.4-check-pet-app/README.md[Exercise 2.4 - (Optional) How is the
Pet App Doing?]
