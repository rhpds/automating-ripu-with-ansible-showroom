...
* link:#workshop-exercise---rinse-and-repeat[Workshop Exercise - Rinse
and Repeat]
** link:#table-of-contents[Table of Contents]
** link:#objectives[Objectives]
** link:#guide[Guide]
*** link:#step-1---what-you-learned[Step 1 - What You Learned]
*** link:#step-2---activities-for-extra-credit[Step 2 - Activities for
Extra Credit]
...
** link:../1.5-custom-modules/README.md[Exercise 1.5 - Custom
Pre-upgrade Checks]
...
link:../1.5-custom-modules/README.md[Custom Pre-upgrade Checks] exercise
...
snapshots as explained in the link:../2.2-snapshots/README.md#lvm[Let’s
