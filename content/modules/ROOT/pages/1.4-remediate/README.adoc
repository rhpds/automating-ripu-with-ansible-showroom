...
* xref:1.5-custom-modules/README.adoc[Exercise 1.5 - Custom Pre-upgrade
Checks]
* xref:1.6-my-pet-app/README.adoc[Exercise 1.6 - Deploy a Pet
Application]
...
to skip ahead to upgrading your RHEL hosts, strap in for this exciting
exercise:
