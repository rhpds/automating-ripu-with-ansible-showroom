...
image::ripu-workflow-hl-remediate.svg[Automation approach
...
+
image::missing_answers_dissected.svg[Details view of missing
...
For example:
+
image::analysis_leapp_answerfile.svg[Setting the
...
+
image::analysis_survey_rhel7_only.svg[Choose ``rhel7'' at the
survey prompt]
+
...
For example:
+
image::rhel7_answer_fixed.svg[Pre-upgrade report of RHEL7 host
...
+
image::rhel7_no_inhibitors.svg[Pre-upgrade report of RHEL7 host
