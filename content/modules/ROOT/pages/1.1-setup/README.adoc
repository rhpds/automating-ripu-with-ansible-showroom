...
|RHEL7 pet app server |`{rhel7_pet_app_server}`
|RHEL8 pet app server |`{rhel8_pet_app_server}`
|RHEL9 pet app server |`{rhel9_pet_app_server}`
|===
...
+
For example, the command `ssh {rhel7_pet_app_server}` will log you into
your RHEL7 server.
