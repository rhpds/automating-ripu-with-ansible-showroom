...
|RHEL7 pet app host 1 |node1
|RHEL8 pet app host 1 |node2
|RHEL9 pet app host 1 |node3
|===
...
+
image::vscode_link.png[Example link to VS Code WebUI,link=self,window=blank]
+
...
`ansible-1`. You can use the `ssh` command to log in to one of your
pet app hosts. Finally, use the highlighted commands to confirm the RHEL OS
version and kernel version installed.
+
For example:
+
image::ssh_login.png[Example ssh login to pet app host,link=self,window=blank]
+
...
+
image::aap_link.png[Example link to AAP Web UI,link=self,window=blank]
+
. Enter the username and password above. This will bring
you to your AAP Web UI dashboard like the example below:
+
image::aap_console_example.png[Example AAP Web UI dashboard,link=self,window=blank]
...
+
image::cockpit_link.png[Example link to RHEL Web Console,link=self,window=blank]
+
. Enter the username and password above. This will
bring you to a RHEL Web Console Overview page like the example below:
+
image::cockpit_example.png[Example RHEL Web Console,link=self,window=blank]
