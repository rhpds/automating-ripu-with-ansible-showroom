...
menu. For example:
+
image::remote_host_menu_with_pets.svg[Remote host menu listing
all pet app servers]
...
+
image::rhel8_os.svg[upward-moray running Red Hat Enterprise Linux
8.7 (Ootpa)]
+
Here is an example of one running RHEL7:
+
image::rhel7_os.svg[Operating System Red Hat Enterprise Linux
Server 7.9 (Maipo)]
* When you navigate to different hosts in the RHEL Web Console, look out
for the ``limited access mode'' warning:
+
image::limited_access.svg[Web console is running in limited
access mode]
+
...
+
image::administrative_access.svg[You now have administrative
access]
...
image::ripu-workflow-hl-review.svg[Automation approach workflow
...
+
image::remote_root_logins_finding.svg[Details view of remote root
logins finding]
+
...
+
image::leapp_bug_finding.svg[Details view usage of deprecated
model bug finding]
+
...
+
image::excluded_repos_finding.svg[Details view of packages
...
details:
+
image::enablerepo_info_finding.svg[Details view of excluded
...
+
image::python_finding.svg[Details view of Difference in Python
versions and support in RHEL8 finding]
+
...
+
image::root_account_inhibitor.svg[Details view of possible
...
+
image::missing_answers_inhibitor.svg[Details view of missing
